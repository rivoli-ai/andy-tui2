...
public static class MarkdownDemo
{
    public static async Task Run((int Width, int Height) viewport, TerminalCapabilities caps)
    {
        ...
        try
        {
            ...
            string text = "# Markdown Demo\n\n## Inline\nThis is **bold**, this is *italic*, and `code`.\n\n## Lists\n- First item\n- Second item\n- Third item\n";
            md.SetText(text);
            ...
            while (running)
            {
                ...
                b.DrawText(new DL.TextRun(2, 1, "Markdown — ESC back; F2 HUD", new DL.Rgb24(200,200,50), null, DL.CellAttrFlags.Bold));
                var baseDl = b.Build();

                var wb = new DL.DisplayListBuilder();
                md.Render(new L.Rect(2, 3, Math.Max(0, viewport.Width - 4), Math.Max(0, viewport.Height - 5)), baseDl, wb);
