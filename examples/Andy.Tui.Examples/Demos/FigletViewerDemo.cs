...
public static class FigletViewerDemo
{
    public static async Task Run((int Width, int Height) viewport, TerminalCapabilities caps)
    {
        ...
        try
        {
            ...
            while (running)
            {
                ...
                b.DrawText(new DL.TextRun(2, 1, "FIGlet Viewer — ESC back; F2 HUD", new DL.Rgb24(200,200,50), null, DL.CellAttrFlags.Bold));
                var baseDl = b.Build();

                var wb = new DL.DisplayListBuilder();
                fv.Render(new L.Rect(2, 3, Math.Max(20, viewport.Width - 4), Math.Max(6, viewport.Height - 5)), baseDl, wb);
