...
public static class BreadcrumbsDemo
{
    public static async Task Run((int Width, int Height) viewport, TerminalCapabilities caps)
    {
        ...
        try
        {
            ...
            string[] items = new[]{"Home","Projects","andy-tui2","src","Andy.Tui.Widgets"};
            bc.SetItems(items);
            ...
            while (running)
            {
                ...
                b.DrawText(new DL.TextRun(2, 1, "Breadcrumbs — ESC back; F2 HUD", new DL.Rgb24(200,200,50), null, DL.CellAttrFlags.Bold));
                var baseDl = b.Build();

                var wb = new DL.DisplayListBuilder();
                bc.Render(new L.Rect(2, 3, Math.Max(0, viewport.Width - 4), 1), baseDl, wb);
