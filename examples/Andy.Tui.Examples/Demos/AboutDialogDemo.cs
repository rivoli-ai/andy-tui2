...
public static class AboutDialogDemo
{
    public static async Task Run((int Width, int Height) viewport, TerminalCapabilities caps)
    {
        ...
        try
        {
            ...
            about.SetContent("About Andy.Tui", "A fast, low-CPU, single-threaded TUI library");
            ...
            while (running)
            {
                ...
                b.DrawText(new DL.TextRun(2, 1, "About Dialog — ESC back; F2 HUD", new DL.Rgb24(200,200,50), null, DL.CellAttrFlags.Bold));
                var baseDl = b.Build();

                var wb = new DL.DisplayListBuilder();
                about.RenderCentered((viewport.Width, viewport.Height), baseDl, wb);
