...
public static class TitleBadgeDemo
{
    public static async Task Run((int Width, int Height) viewport, TerminalCapabilities caps)
    {
        ...
        try
        {
            ...
            while (running)
            {
                ...
                b.DrawText(new DL.TextRun(2, 1, "TitleBadge — ESC back; F2 HUD", new DL.Rgb24(200,200,50), null, DL.CellAttrFlags.Bold));
                var baseDl = b.Build();

                var wb = new DL.DisplayListBuilder();
                tb.Render(new L.Rect(2, 3, Math.Max(20, viewport.Width - 4), 1), baseDl, wb);
