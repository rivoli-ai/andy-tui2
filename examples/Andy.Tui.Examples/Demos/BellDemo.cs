        ...
        try
        {
            ...
            while (running)
            {
                ...
                while (Console.KeyAvailable)
                {
                    ...
                    if (k.Key == ConsoleKey.B) bell.Show("New message", ttlFrames: 90);
                }
                ...
                b.DrawText(new DL.TextRun(2, 1, "Bell — Press B to trigger; ESC back; F2 HUD", new DL.Rgb24(200,200,50), null, DL.CellAttrFlags.Bold));
                var baseDl = b.Build();

                var wb = new DL.DisplayListBuilder();
                if (bell.IsVisible) bell.RenderAt(2, 3, baseDl, wb);
                bell.Tick();
