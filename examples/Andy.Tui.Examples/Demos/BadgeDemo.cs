...
public static class BadgeDemo
{
    public static async Task Run((int Width, int Height) viewport, TerminalCapabilities caps)
    {
        ...
        {
            bool running = true;
            var b1 = new Andy.Tui.Widgets.Badge(); b1.SetText("NEW");
            var b2 = new Andy.Tui.Widgets.Badge(); b2.SetText("99+"); b2.SetColors(new DL.Rgb24(0,0,0), new DL.Rgb24(200,200,80), new DL.Rgb24(180,180,60));
            ...
            while (running)
            {
                ...
                b.DrawText(new DL.TextRun(2, 1, "Badge — ESC back; F2 HUD", new DL.Rgb24(200,200,50), null, DL.CellAttrFlags.Bold));
                var baseDl = b.Build();

                var wb = new DL.DisplayListBuilder();
                b1.RenderAt(2, 3, baseDl, wb);
                b2.RenderAt(10, 3, baseDl, wb);
