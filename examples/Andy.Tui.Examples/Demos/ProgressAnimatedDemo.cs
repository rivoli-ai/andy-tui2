...
public static class ProgressAnimatedDemo
{
    public static async Task Run((int Width, int Height) viewport, TerminalCapabilities caps)
    {
        ...
        try
        {
            ...
            while (running)
            {
                ...
                b.DrawText(new DL.TextRun(2, 1, "ProgressBar + Slider — h HUD; ESC/Q back", new DL.Rgb24(200, 200, 50), null, DL.CellAttrFlags.Bold));
                var baseDl = b.Build();
                var wb = new DL.DisplayListBuilder();
                new Andy.Tui.Widgets.ProgressBar { Value = val }.Render(new Andy.Tui.Layout.Rect(2, 3, 40, 1), baseDl, wb);
                new Andy.Tui.Widgets.Slider { Value = val }.Render(new Andy.Tui.Layout.Rect(2, 5, 40, 1), baseDl, wb);
